...
src/main.py
-----------
Updated research artefact paths to comply with **iteration-49** mandatory
layout (replacing the previous iteration-48 layout).  All JSON result files
are now stored under `.research/iteration49/` and figures under
`.research/iteration49/images/` as required by the evaluation harness.
"""
...
# ---------------------------------------------------------------------------
#  Mandatory research directory layout (iteration-49) -----------------------
# ---------------------------------------------------------------------------
RESULT_DIR = ROOT / ".research" / "iteration49"
