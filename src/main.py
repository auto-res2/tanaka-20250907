...
src/main.py
-----------
Updated to comply with the *iteration-11* directory layout requirements.
...
# Mandatory research directory layout (iteration-11) ------------------------
RESULT_DIR = ROOT / ".research" / "iteration11"
